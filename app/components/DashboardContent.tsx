...
const ErrorDisplay = ({ error }: ErrorDisplayProps) => (
    <div className="mb-6 bg-red-50 p-4 rounded-lg text-red-500">
        {error}
        <div className="mt-2">
            <Link href="/dashboard/debug" className="text-blue-500 underline hover:cursor-pointer">
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex flex-wrap gap-2 mt-4">
                                    <Link
                                        ...
                                        className="px-3 py-1 bg-gray-100 text-gray-800 rounded-md hover:bg-gray-200 text-sm transition-colors hover:cursor-pointer"
                                    >
                                        View
                                    </Link>
                                    <Link
                                        href={`/listing/${listing.id}/edit`}
                                        className="px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200 text-sm transition-colors hover:cursor-pointer"
                                    >
                                        Edit
                                    </Link>
                                    <Link
                                        href={`/listing/${listing.id}/availability`}
                                        className="px-3 py-1 bg-green-100 text-green-800 rounded-md hover:bg-green-200 text-sm transition-colors hover:cursor-pointer"
                                    >
                                        Manage Availability
                                    </Link>
                                    <button
                                        onClick={() => handleDeleteListing(listing.id)}
                                        className="px-3 py-1 bg-rose-100 text-rose-800 rounded-md hover:bg-rose-200 text-sm transition-colors hover:cursor-pointer"
                                    >
                                        Delete
                                    </button>
                                </div>
                                            ...
                                            {reservation.status === 'pending' && (
                                                <div className="flex space-x-2">
                                                    <button
                                                        ...
                                                        className="px-2 py-1 text-xs bg-green-500 text-white rounded hover:bg-green-600 transition-colors disabled:opacity-50 hover:cursor-pointer"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isUpdating === reservation.id}
                                                        className="px-2 py-1 text-xs bg-red-500 text-white rounded hover:bg-red-600 transition-colors disabled:opacity-50 hover:cursor-pointer"
                                                    >
